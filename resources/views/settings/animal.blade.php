...
@section('title', 'जन्तु/जनावर वा पशुपंक्षि')
    ...
    @if (isset($animal))
        <div class="card text-sm mt-1">
            <div class="card-header">
                <div class="card-text">
                    <p class="mb-0">{{ __('जन्तु/जनावर वा पशुपंक्षि सच्याउने') }}</p>
                </div>
                <div class=" card-body">
                                ...
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            {{ __('जन्तु/जनावर वा पशुपंक्षि') }} <span
                                    ...
                                    @error('name')
                                        <p class="invalid-feedback" style="font-size: 1rem">
                                            {{ __('जन्तु/जनावर वा पशुपंक्षिको फिल्ड खाली छ ') }}
                                        </p>
                                    @enderror
                                </div>
                            </div>
        ...
        <div class="card-header my-2">
            <div class="row my-1">
                <div class="col-md-6" style="margin-bottom:-5px;">
                    <p class="">{{ __('जन्तु/जनावर वा पशुपंक्षिको सुचिहरु') }}</p>
                </div>
                <div class="
                        col-md-6 text-right">
                        <a class="btn text-white btn-sm btn-primary" data-toggle="modal" data-target="#modal-lg">
                            {{ __('जन्तु/जनावर वा पशुपंक्षि थप्नुहोस') }}</a>
                </div>
            </div>
        </div>
        <!-- /.card-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('जन्तु/जनावर वा पशुपंक्षि') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach ($animals as $animal)
                        <tr>
                            ...
                            <td class="text-center"><a href="{{ route('animal.edit', $animal) }}"
                                    class="btn-sm btn-success"><i class="fas fa-edit px-1"></i> {{ __('सच्याउने') }}</a>
                                <a href="#" class="btn-sm btn-danger"
                                    onclick="event.preventDefault();
                                                                                                            document.getElementById('delete_animal{{ $i }}').submit();">
                                    <i class="fas fa-trash-alt px-2"></i>{{ __('हटाउनुहोस्') }}</a>
                            </td>
                            <form id="delete_animal{{ $i }}"
                                action="{{ route('animal.destroy', $animal) }}" method="POST" class="d-none">
                                @method('DELETE')
                                @csrf
                            </form>
                        </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('जन्तु/जनावर वा पशुपंक्षि थप्नुहोस') }}</h5>
                    <button type=" button"
